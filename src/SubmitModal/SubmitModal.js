...
//             <Form.Group controlId="formBasicName">
//               <Form.Label className="FormLabel">Last Name</Form.Label>
//               <Form.Control className="FormInput" type="text" placeholder="Enter last name" />
//             </Form.Group>
...
//             <Form.Group controlId="formBasicMessage">
//               <Form.Label>Thank you for your generosity! Please make sure the information
//                 below is the correct family you have choose to select. A confirmation email with the 
//                 information will be sent to your email shortly.
//               </Form.Label>
//               <h6>{mothersFirstName}'s {numberOfChildren} student(s)</h6>
//               <ul>
//                 {Array.isArray(childNames) && childNames.map((child, index) => {
